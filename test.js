...
function test_deDE_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `deDE_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_en_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `en_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_esES_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `esES_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_es419_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `es419_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_frFR_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `frFR_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_itIT_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `itIT_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_nlNL_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `nlNL_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_ptPT_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `ptPT_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
...
function test_ptBR_parseViews() {
  ...
  for (let [input, expected] of Object.entries(testCases)) {
    ...
    console.assert(
      actual === expected,
      `ptBR_parseViews failed for ${input} (${expected} should be ${actual})`,
    );
  }
}
